...
//            connection.commit();
    ...
    public static PrescriptionPrintModel fetchPrescriptionById(String appointmentNumber) {
        PrescriptionPrintModel prescriptionData = new PrescriptionPrintModel();
        ...
        try (PreparedStatement stmt = connection.prepareStatement(query)) {
            ...
            if (rs.next()) {
                ...
                if (medicinesString != null && !medicinesString.isEmpty()) {
                    ObservableList<MedicationModel> medicationList = FXCollections.observableArrayList();
    ...
    private static List<MedicationModel> parseMedications(String medicines) {
