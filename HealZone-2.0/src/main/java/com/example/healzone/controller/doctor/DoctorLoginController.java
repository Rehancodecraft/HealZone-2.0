...
import static com.example.healzone.model.LoggedInDoctorModel.getCurrentDoctor;
...
public class DoctorLoginController {
    ...
    public void onLoginButtonClicked(ActionEvent event) throws IOException {
        ...
        if (loggedIn) {
            SessionManager.logIn(DoctorModel.getGovtID(), true); // Use Doctor.govtID, set isDoctor to true
            doctorLoginErrorMessage.setText("Logged in successfully: " + DoctorModel.getFirstName() + " " + DoctorModel.getLastName());
            System.out.println("LoggedIn");

            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/healzone/StartView/doctor-homepage.fxml"));
