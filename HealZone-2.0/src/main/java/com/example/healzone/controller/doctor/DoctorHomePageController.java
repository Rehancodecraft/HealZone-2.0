...
public class DoctorHomePageController {
    ...
    private void initialize() {
        ...
        try {
            String firstName = DoctorModel.getFirstName();
            String lastName = DoctorModel.getLastName();
        ...
        Task<Map<String, Integer>> statsTask = new Task<>() {
            ...
            protected Map<String, Integer> call() throws Exception {
                try {
                    ...
                    stats.put("totalBooked", AppointmentRepository.getTotalBookedAppointments(doctorId, today));
                    stats.put("attended", AppointmentRepository.getAttendedAppointments(doctorId, today));
        ...
        Task<Parent> loadTask = new Task<>() {
            ...
            protected Parent call() throws Exception {
                try {
                    ...
                    List<Map<String, Object>> history = AppointmentRepository.getAppointmentHistoryForDoctor(doctorId);
        ...
        Task<Parent> loadTask = new Task<>() {
            ...
            protected Parent call() throws Exception {
                try {
                    ...
                    controller.setGovtIdField(DoctorModel.getGovtID() != null ? DoctorModel.getGovtID() : "");
                    controller.setFirstNameField(DoctorModel.getFirstName() != null ? DoctorModel.getFirstName() : "");
                    controller.setLastNameField(DoctorModel.getLastName() != null ? DoctorModel.getLastName() : "");
                    controller.setEmailField(DoctorModel.getEmail() != null ? DoctorModel.getEmail() : "");
                    controller.setPhoneNumberField(DoctorModel.getPhone() != null ? DoctorModel.getPhone() : "");
                    controller.setSpecializationField(DoctorModel.getSpecialization() != null ? DoctorModel.getSpecialization() : "");
                    controller.setLicenseNumberField(DoctorModel.getMedicalLicenseNumber() != null ? DoctorModel.getMedicalLicenseNumber() : "");
                    controller.setExperienceField(DoctorModel.getExperience() != null ? DoctorModel.getExperience() : "");
                    controller.setDegreesField(DoctorModel.getDegrees() != null ? DoctorModel.getDegrees() : "");
                    controller.setBioTextArea(DoctorModel.getBio() != null ? DoctorModel.getBio() : "");
                    controller.setHospitalNameField(DoctorModel.getHospitalName() != null ? DoctorModel.getHospitalName() : "");
                    controller.setConsultationFeeField(DoctorModel.getConsultationFee() != null ? DoctorModel.getConsultationFee() : "");
                    controller.setHospitalAddressArea(DoctorModel.getHospitalAddress() != null ? DoctorModel.getHospitalAddress() : "");

                    Map<String, TimeSlotModel> availability = DoctorModel.getAvailability();
                    if (availability != null && !availability.isEmpty()) {
                        for (Map.Entry<String, TimeSlotModel> entry : availability.entrySet()) {
