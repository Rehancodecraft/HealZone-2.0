...
import com.example.healzone.controller.doctor.DoctorDashboardController;
import com.example.healzone.controller.doctor.DoctorPrescriptionController;
...
public class PrescriptionViewController implements Initializable {
    ...
    // Data Storage
    private PrescriptionPrintModel prescriptionData;
    ...
    public void loadPrescription(PrescriptionPrintModel prescriptionData) {
    ...
    private void populateMedications() {
        ...
        List<MedicationModel> medications = prescriptionData.getMedications();
    ...
    private VBox createMedicationItem(int number, MedicationModel medication) {
                ...
                if (currentAppointment != null) {
                    ...
                    if (result.isPresent() && result.get() == okayButton) {
                        ...
                        Task<Void> attendTask = new Task<>() {
                            @Override
                            protected Void call() {
                                AppointmentRepository.markAsAttended(prescriptionData.getDoctorId(), (String) currentAppointment.get("appointment_number"));
                                return null;
                            }
                        };
    ...
    private void savePrescriptionToDatabase() {
        ...
        boolean first = true;
        for (MedicationModel medication : prescriptionData.getMedications()) {
            if (!first) {
    ...
    public void setDoctorPrescriptionData(String doctorId, String patientId, ObservableList<MedicationPrintModel> medicinesList) {
        if (prescriptionData == null) {
            prescriptionData = new PrescriptionPrintModel();
        }
