...
import com.example.healzone.controller.patient.PatientHistoryController;
    ...
    private void loadNextAppointment() {
        Task<Optional<Map<String, Object>>> loadTask = new Task<>() {
            ...
            protected Optional<Map<String, Object>> call() {
                ...
                List<Map<String, Object>> appointments = AppointmentRepository.getAppointmentsForDoctorToday(doctorId, today);
        ...
        dialog.showAndWait().ifPresent(response -> {
            if (response == okayButton) {
                ...
                Task<Void> attendTask = new Task<>() {
                    @Override
                    protected Void call() {
                        AppointmentRepository.markAsAttended(doctorId, (String) currentAppointment.get("appointment_number"));
                        return null;
                    }
                };
