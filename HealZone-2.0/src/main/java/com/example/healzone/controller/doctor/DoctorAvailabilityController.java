...
public class DoctorAvailabilityController {
    ...
    private void createAvailabilityOverviewItem(String day, TimeSlotModel slot) {
    ...
    private void setDaySchedule(String day, TimeSlotModel slot) {
        ...
        for (Map.Entry<String, ComboBox<String>> entry : dayComboMap.entrySet()) {
            ...
            if ("Available".equals(combo.getValue())) {
                ...
                try {
                    ...
                    TimeSlotModel slot = new TimeSlotModel(startTime, endTime);
        ...
        for (Map.Entry<String, ComboBox<String>> entry : dayComboMap.entrySet()) {
            ...
            if ("Available".equals(combo.getValue())) {
                ...
                try {
                    LocalTime startTime = LocalTime.parse(startField.getText());
                    LocalTime endTime = LocalTime.parse(endField.getText());
                    DoctorRepository.insertAvailabilityOfDoctor(govtId, day, startTime, endTime);
                } catch (DateTimeParseException e) {
