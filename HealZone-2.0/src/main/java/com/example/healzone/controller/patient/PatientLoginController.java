...
import static com.example.healzone.model.LoggedInPatientModel.getCurrentPatient;
...
public class PatientLoginController {
    ...
    public void onLoginButtonClicked(ActionEvent event) throws IOException {
        ...
        if (loggedIn) {
            String patientId = PatientModel.getPhone(); // Use phone number as unique ID
            if (patientId == null) {
            ...
            patientLoginErrorMessage.setText("Logged in as: " + PatientModel.getName());
