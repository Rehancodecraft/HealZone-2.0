...
import com.example.healzone.model.ExtendedPrescriptionModel;
...
import com.example.healzone.model.MedicationModel;
...
import com.example.healzone.model.MedicationPrintModel;
...
public class DoctorPrescriptionController implements Initializable {
    ...
    @FXML private TableView<MedicationPrintModel> medicinesTable;
    @FXML private TableColumn<MedicationPrintModel, String> medicineNameColumn;
    @FXML private TableColumn<MedicationPrintModel, String> typeColumn;
    @FXML private TableColumn<MedicationPrintModel, String> dosageColumn;
    @FXML private TableColumn<MedicationPrintModel, String> frequencyColumn;
    @FXML private TableColumn<MedicationPrintModel, String> timingColumn;
    @FXML private TableColumn<MedicationPrintModel, String> durationColumn;
    @FXML private TableColumn<MedicationPrintModel, String> instructionsColumn;
    @FXML private TableColumn<MedicationPrintModel, Void> actionColumn;
    ...
    // Data Storage
    private ObservableList<MedicationPrintModel> medicinesList;
    ...
    private void initializeTable() {
        ...
        actionColumn.setCellFactory(param -> new TableCell<MedicationPrintModel, Void>() {
            private final Button removeButton = new Button("Remove");
            {
                ...
                removeButton.setOnAction(event -> {
                    MedicationPrintModel medicine = getTableView().getItems().get(getIndex());
    ...
    private void addMedicine(ActionEvent event) {
        if (validateMedicineForm()) {
            MedicationPrintModel medicine = new MedicationPrintModel(
    ...
    private void removeMedicine(MedicationPrintModel medicine) {
                ...
                if (currentAppointment != null) {
                    ...
                    if (result.isPresent() && result.get() == okayButton) {
                        ...
                        Task<Void> attendTask = new Task<>() {
                            @Override
                            protected Void call() {
                                AppointmentRepository.markAsAttended(currentDoctorId, (String) currentAppointment.get("appointment_number"));
                                return null;
                            }
                        };
    ...
    private void savePrescriptionToDatabase(String appointmentNumber) {
        PrescriptionRepository prescription = new PrescriptionRepository();
        ...
        boolean first = true;
        for (MedicationPrintModel medicine : medicinesList) {
    ...
    public void setPatientInfo(String name, String age, String gender) {
        ...
        if (currentAppointment != null) {
            ...
            Map<String, Object> patientInfo = AppointmentRepository.getPatientInfoByPhone(currentPatientId);
    ...
    private ExtendedPrescriptionModel createPrescriptionData() {
        ExtendedPrescriptionModel prescriptionData = new ExtendedPrescriptionModel();
        ...
        ObservableList<MedicationModel> medicationDataList = FXCollections.observableArrayList();
        for (MedicationPrintModel medicine : medicinesList) {
            MedicationModel medData = new MedicationModel(
                    medicine.getMedicineName(),
                    medicine.getType(),
                    medicine.getDosage(),
                    medicine.getFrequency(),
