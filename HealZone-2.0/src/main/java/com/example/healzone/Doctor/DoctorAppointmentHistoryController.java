...
//                stats.put("total", Appointments.getTotalCompletedAppointments(doctorId));
//                stats.put("thisMonth", Appointments.getCompletedAppointmentsThisMonth(doctorId));
//                stats.put("cancelled", Appointments.getCancelledAppointments(doctorId));
//                return stats;
//            }
//        };
//
...
//            Platform.runLater(() -> {
////                showError("Failed to load appointment history. Please try again.");
//            });
//        });
//
...
//                    refreshButton.setText("Refresh");
//                }
////                showError("Failed to refresh history. Please try again.");
//            });
//        });
//
...
//            // Implement date filtering based on your date format
//            // This is a placeholder - adjust according to your date format
//            try {
...
////
////            // Get the controller and pass appointment data
