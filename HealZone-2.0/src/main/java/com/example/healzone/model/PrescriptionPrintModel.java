...
public class PrescriptionPrintModel {
    ...
    private List<MedicationModel> medications; // Already contains the parsed medicines
    ...
    public void setMedications(List<MedicationModel> medications) { this.medications = medications != null ? medications : new ArrayList<>(); }
